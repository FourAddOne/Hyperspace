...
public class FriendController {
    ...
    // 获取好友列表
    @GetMapping("/list")
    public ResVO<List<UserLoginVO>> getFriendList(@RequestAttribute("userId") String userId) {
        try {
            List<UserLoginVO> friends = friendServer.getFriendList(userId);
    ...
    // 获取好友申请列表
    @GetMapping("/requests")
    public ResVO<List<UserLoginVO>> getFriendRequests(@RequestAttribute("userId") String userId) {
        try {
            List<UserLoginVO> requests = friendServer.getFriendRequests(userId);
